<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        <img src="<?=base_url('assets/img/black.png') ?>" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">SimTA NG 2.0</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="<?= base_url('Proposal') ?>">
            ...
            <span class="nav-link-text ms-1">Proposal TA</span>
          </a>
        </li>
        <li class="nav-item">
      ...
      <div class="card card-plain shadow-none" id="sidenavCard">
        ...
        <div class="card-body text-center p-3 w-100 pt-0">
          <div class="docs-info">
            ...
            <p class="text-xs font-weight-bold mb-0">Silahkan baca User Guide</p>
          </div>
        </div>
      </div>
